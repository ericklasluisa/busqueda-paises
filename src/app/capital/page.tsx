...
import { searchCountriesByCapital } from "../lib/searchCountriesByCapital";
...
export default function Home() {
  ...
  useEffect(() => {
    const fetchCountries = async () => {
      ...
      const countriesData = await searchCountriesByCapital(term);
  ...
  return (
    <main className="p-8 bg-gray-100">
      <h1 className="text-3xl font-bold mb-8 text-blue-600">Buscar Países por Capital</h1>
      <input
        type="text"
